...
void CInput::CAM_ToFirstPersonView(void)
{
...
static ConCommand firstperson( "firstperson", ::CAM_ToFirstPerson, "Switch to firstperson camera. (Useless in Discharge, use firstpersonview instead)" );
//static ConCommand firstpersonview("firstpersonview", ::CAM_ToFirstPersonView, "Switch to firstperson camera.", FCVAR_CHEAT);
#endif
